...
// Local copy of the shell's PanelHero with an exposed metaColor, so the
// auto-lock countdown can use the accent color without repainting the hero.
Item {
  id: root
  ...
  property color metaColor: Qt.darker(foreground, 1.4)
